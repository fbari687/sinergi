  ...
  <Dialog v-model:visible="show" modal header="Laporkan Konten" :style="{ width: '450px' }">
    <div class="flex flex-col gap-4">
      ...
      <div class="flex justify-end gap-2 mt-3">
        <button class="px-3 py-2 text-gray-500 hover:bg-gray-100 rounded-lg" @click="closeModal">Batal</button>
        <button class="px-4 py-2 bg-red-600 text-white rounded-lg" @click="submit">Laporkan</button>
      </div>
    </div>
  </Dialog>
</template>
